...
RSpec.describe Stack do
	...
	describe "attributes" do 
		it "has getters and detters for data_store" do 
		...
		it "has a default valie of [] for data store" do 
	...
	describe "behavior" do 
		...
		it "pushes in an elemenet to the end" do 
			expect(@stack.stack_display).to eq([1, 2, 3])
		end
		describe "pop" do 
			it "pops th last-in elemenet" do 
